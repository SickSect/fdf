...
int	main_pg(t_data *data)
{
	...
	mlx_string_put(data->mlx, data->win, 10, y + 40,
		create_trgb(255, 255, 255, 255), "MULTIPLY Z - z / x");
	mlx_string_put(data->mlx, data->win, 10, y + 50,
		create_trgb(255, 255, 255, 255), "ROTATE- w/s/a/d");
	mlx_loop(data->mlx);
	return (0);
}
